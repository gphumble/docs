...
## Donor status versus dashboard health

The dashboard's Champion, Rising, Steady, Slipping, and Lapsed labels are donor-health indicators. They are not the same three-value classification used in the contact list. If a status looks surprising, inspect the gift dates and giving history before changing the records. Do not add a gift merely to force a status change.
