...
## Help a donor use the portal

Ask the donor to use their latest management link and review the amount and next billing date before making a change. After saving, they should read the confirmation and reload the displayed subscription details. Keep the link private because possession of it provides access.

If a donor cannot obtain a working link through the available communication, use **Get support**. Cancelling future billing does not refund previous contributions; use the appropriate refund process for a past payment.
