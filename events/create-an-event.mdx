...
After creating it, review the date, timezone, venue, payment account, and enabled options on the event. Add ticket tiers and public-page content before publishing. If the start/end times are wrong, correct them before sharing the public link.
